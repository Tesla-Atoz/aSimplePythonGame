...
# It's time to actually make a simple command line game i put together everything
# I've learned so far about Python. The game goes like this:
...
# I have written neccessary DOC STRINGS to let understand the functionality of every function
